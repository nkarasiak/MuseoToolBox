...
- [museotoolbox.raster_tools](https://museotoolbox.readthedocs.io/en/latest/modules/museotoolbox.raster_tools.html)
  - Extract bands values from vector ROI (polygons/points) (function : [extract_values](https://museotoolbox.readthedocs.io/en/latest/modules/raster_tools/museotoolbox.raster_tools.extract_values.html))
