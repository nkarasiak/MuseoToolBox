...
nomenclature = sp.loadtxt('/home/nkarasiak/GDrive/TEFOR/Code/S2/nomenclature.csv',delimiter=',',dtype=str)
...
box=plt.boxplot(agreements,labels=speciesName,patch_artist=True,widths=0.9,boxprops=boxprops)
