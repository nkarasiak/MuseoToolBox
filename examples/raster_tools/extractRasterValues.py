...
X = mtb.raster_tools.extract_values(raster,vector)
...
X,y = mtb.raster_tools.extract_values(raster,vector,'class')
...
X,y,g = mtb.raster_tools.extract_values(raster,vector,'class','uniquefid')
