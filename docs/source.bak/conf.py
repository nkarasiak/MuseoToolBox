...
project = u'MTB Museo ToolBox'
copyright = u'Nicolas Karasiak'
author = u'Nicolas Karasiak'
...
latex_documents = [
    (master_doc, 'MTB.tex', u'MTB Museo ToolBox latex',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'mtb', u'MTB Museo ToolBox Documentation',
     [author], 1)
]
...
sphinx_gallery_conf = {   
    ...
    'reference_url': {
        ...
        'scipy': 'http://docs.scipy.org/doc/scipy-0.19.0/reference'}
}
