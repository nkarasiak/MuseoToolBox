...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    GridSearchCV(cv=<museotoolbox.cross_validation.RandomStratifiedKFold object at 0x7f1bb830f438>,
           error_score='raise',
           ...
           verbose=1)
    {'mean_fit_time': array([1.62378156, 4.01614904]), 'std_fit_time': array([0.00593293, 0.0310216 ]), 'mean_score_time': array([1.77278578, 1.76856172]), 'std_score_time': array([0.05621612, 0.01880014]), 'param_n_estimators': masked_array(data=[100, 200],
                 mask=[False, False],
           fill_value='?',
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  59.573 seconds)
