...
class Moran:
    ...
    def __init__(self,inRaster,inMaskRaster=False,transform='r',lag=1,weights=False,intermediate_lag=True):
        ...
        if isinstance(inRaster,(np.ma.core.MaskedArray,np.ndarray)):
            ...
            rM=rasterMath(raster,inMaskRaster=mask,return_3d=True,verbose=False)
...
if __name__ == '__main__':
    raster='/mnt/DATA/Formosat_2006-2014/v2/band1.vrt'
    mask='/mnt/DATA/Formosat_2006-2014/v2/data/forestMask.tif'
#    raster='/home/nicolas/Documents/moran/sample_12x12.tif'
#    mask=False
    t0=time()
    
    moran = Moran(raster,mask,lag=3,transform='r')
    print('moran\'s I lag : '+str(moran.scores['I']))
    print(str(time()-t0))
