...
class learnAndPredict:
    ...
    def loadModel(self,path):
        ...
        # if not self.scale but scale was used in a previous call of learnAndPredict
    ...
    def predictFromRaster(self,inRaster,outRaster,outConfidencePerClass=False,outConfidence=False,inMaskRaster=False,outNoData=0):
        ...
        if outConfidence:
            rM.addFunction(self.predictConfidenceOfPredictedClassFromArray,outConfidence,outNBand=False,outGdalDT=3,outNoData=-9999)    
        rM.run()
